        ...
        <div class="container">
            <div id="leftbar" class="col-sm-3">
                ...
                <div id="sidebar" class="col-sm-9">
                    <div class="panel panel-default">
                        <div class="panel-heading"><i class="fa fa-envelope-o"></i> <?php echo SAULANG3; ?> <a class="collapse-block"><i class="fa fa-chevron-up"></i></a></div>
                        <div class="panel-body messagesbox">
                            <table class="table table-striped">
                                <thead class="messages-table-header">
                                    <tr>
                                    <th><i class="fa fa-user"></i> Usuario</th>
                                    <th><i class="fa fa-thumb-tack"></i> Asunto</th>
                                    <th><i class="fa fa-calendar"></i> Fecha</th>
                                    <th><i class="fa fa-cog"></i> Accion</th>
                                    </tr>
                                </thead>
