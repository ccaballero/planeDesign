    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-right" role="search" method="GET" action="search">
        <div class="input-group">
          <input type="text" class="form-control" name="find" placeholder="<?php echo SAULANG5; ?>" value="<?php echo $finder; ?>">
...
<!-- panels -->
<div class="panel panel-default">
  <div class="panel-heading"><i class="fa fa-comment-o"></i> <?php echo SAULANG63.' '.'<strong>'.$finder.'</strong>'; ?> <a class="collapse-block"><i class="fa fa-chevron-up"></i></a></div>
